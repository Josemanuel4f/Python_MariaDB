...
CREATE TABLE propietarios(
    ...
    CONSTRAINT dni_prop CHECK (DNI REGEXP '[0-9]{8}[A-Z]{1}'),
    constraint nom_prop CHECK (nombre regexp '^[A-Z]'),
    constraint telf_prop CHECK (telefono REGEXP'^6')
);
...
INSERT INTO clinica (codigo, nombre, direccion) VALUES(6815375, 'SHospital de Valme, 'Avenida Sevilla');
